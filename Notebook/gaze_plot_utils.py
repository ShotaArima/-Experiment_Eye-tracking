...
def plot_gaze_heatmap(df, x_col='Gaze point X', y_col='Gaze point Y', screen_width=1920, screen_height=1080, bins=(80, 45), cmap='hot', title='Gaze Heatmap on AOI'):
...
def plot_gaze_heatmap_with_background(df, background_path, x_col='Gaze point X', y_col='Gaze point Y', bins=(80, 45), cmap='hot', alpha=0.5, title='Gaze Heatmap Overlay on AOI Image'):
